...
*log close
log using "Stata/Capital Adequacy Cov/capital_adequacy_cov.log", replace
drop _all
*Import csv
import delimited "Clean Data/capital_adequacy_cov.csv"
save "Stata/Capital Adequacy Cov/capital_adequacy_cov.dta", replace
*Load data
use "Stata/Capital Adequacy Cov/capital_adequacy_cov.dta", clear
...
save "Stata/Merged Cov/capital_adequacy_cov.dta", replace
