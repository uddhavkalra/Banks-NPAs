...
*log close
log using "Stata/Priority/Priority.log", replace
drop _all
*Import csv
import delimited "Clean Data/priority_break_up.csv"
save "Stata/Priority/priority.dta", replace
*Load data
use "Stata/Priority/priority.dta", clear
