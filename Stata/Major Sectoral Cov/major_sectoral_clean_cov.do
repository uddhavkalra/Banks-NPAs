...
*log close
log using "Stata/Major Sectoral Cov/major_sectoral_cov.log", replace
drop _all
*Import csv
import delimited "Clean Data/major_sectoral_cov.csv"
save "Stata/Major Sectoral Cov/major_sectoral_cov.dta", replace
*Load data
use "Stata/Major Sectoral Cov/major_sectoral_cov.dta", clear
