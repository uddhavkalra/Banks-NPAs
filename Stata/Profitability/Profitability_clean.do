...
*log close
log using "Stata/Profitability/profiatbility.log", replace
drop _all
*Import csv
import delimited "Clean Data/profitability.csv"
save "Stata/Profitability/profitability.dta", replace
*Load data
use "Stata/Profitability/profitability.dta", clear
