...
*log close
log using "Stata/Merged Cov/merge_all2_cov.log", replace
drop _all
...
save "Stata/Merged Cov/bank_vars_all_cov.dta", replace
...
|banks == "ANDHRA BANK" |banks == "BHARATIYA MAHILA BANK LTD."  ///
|banks == "CORPORATION BANK" |banks == "IDBI BANK LIMITED(055)" ///
|banks == "ING VYSYA BANK LTD" |banks == "LAKSHMI VILAS BANK LTD" ///
|banks == "ORIENTAL BANK OF COMMERCE" |banks == "STATE BANK OF BIKANER AND JAIPUR" ///
|banks == "STATE BANK OF HYDERABAD" |banks == "STATE BANK OF MYSORE" ///
|banks == "STATE BANK OF PATIALA" |banks == "STATE BANK OF TRAVANCORE" ///
|banks == "SYNDICATE BANK" |banks == "UNITED BANK OF INDIA" ///
