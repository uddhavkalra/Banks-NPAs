...
*log close
log using "Stata/Balance Sheet Cov/balance_sheet_cov.log", replace
drop _all
*Import csv
import delimited "Clean Data/balance_sheet_cov.csv"
save "Stata/Balance Sheet Cov/balance_sheet_cov.dta", replace
*Load data
use "Stata/Balance Sheet Cov/balance_sheet_cov.dta", clear
