...
*log close
log using "Stata/Infrastructure Cov/infra_cov.log", replace
drop _all
*Import csv
import delimited "Clean Data/infrastructure_cov.csv"
save "Stata/Infrastructure Cov/infra_cov.dta", replace
*Load data
use "Stata/Infrastructure Cov/infra_cov.dta", clear
...
v40 v45 v46 v47 v48 v49 v50 v51 v52 v53 v54 v55 v56 v57) ///
