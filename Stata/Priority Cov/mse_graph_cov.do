...
*log close
log using "Stata/Priority Cov/mse_graph_cov.log", replace
drop _all
...
saving("Graphs/gph/mse_sum_graph_cov", replace)
graph export "Graphs/jpg/mse_sum_graph_cov.jpg", replace
...
lab(3 "Public Banks") lab(4 "Small Finance Banks")) ///
saving("Graphs/gph/mse_avg_graph_cov", replace) 
graph export "Graphs/jpg/mse_avg_graph_cov.jpg", replace
...
xtitle("Quarter") legend(lab(1 "Foreign Banks") lab(2 "Private Banks") ///
lab(3 "Public Banks") lab(4 "Small Finance Banks")) ///
saving("Graphs/gph/mse_rat_graph_cov", replace) 
graph export "Graphs/jpg/mse_rat_graph_cov.jpg", replace
...
legend(lab(1 "Foreign Banks") lab(2 "Private Banks") ///
lab(3 "Public Banks") lab(4 "Small Finance Banks")) ///
saving("Graphs/gph/pri_graph", replace)
graph export "Graphs/jpg/pri_graph.jpg", replace
...
legend(lab(1 "Foreign Banks") lab(2 "Private Banks") ///
lab(3 "Public Banks") lab(4 "Small Finance Banks")) ///
saving("Graphs/gph/npri_graph", replace)
graph export "Graphs/jpg/npri_graph.jpg", replace
