...
*log close
log using "Stata/NPAs/NPA_clean.log", replace
drop _all
**Import csv
import delimited "Clean Data/asset_quality.csv"
save "Stata/NPAs/asset_quality.dta", replace
*Load data
...
save "Stata/Merged/asset_quality.dta", replace
