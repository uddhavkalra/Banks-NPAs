...
*log close
log using "Stata/Performance Indicators Cov/perform_ind_cov.log", replace
drop _all
*Import csv
import delimited "Clean data/performance_indicators_cov.csv"
save "Stata/Performance Indicators Cov/perform_ind_cov.dta", replace
*Load data
use "Stata/Performance Indicators Cov/perform_ind_cov.dta", clear
